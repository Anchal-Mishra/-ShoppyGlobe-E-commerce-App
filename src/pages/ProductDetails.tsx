  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-[60vh]">
        <InfinitySpin width="200" color="#780000" />
      </div>
    );
  }
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 items-center ">
            <button
              ...
              className="bg-[#317873] hover:bg-[#780000] transition-all duration-300 ease-linear text-white px-4 py-2 mt-2 rounded"
            >
              Add to Cart
            </button>
            <Link to="/">
              <button className="bg-[#317873] hover:bg-[#780000] transition-all duration-300 ease-linear text-white px-4 py-2 mt-2 rounded">
