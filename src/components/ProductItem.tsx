...
const ProductItem = ({
  ...
  return (
    <div className="border p-4 rounded-lg shadow hover:shadow-lg transition-all duration-200 ease-linear  cursor-pointer bg-[#FFF5EE]" >
      {/* Link to products according to id */}
      <Link to={`/products/${id}`}>
        <img
          src={image}
          alt={name}
          className="h-56 w-full  bg-[#FFF5EE] mb-3 rounded-lg"
        />
      ...
      <button
        ...
        className="bg-[#317873] hover:bg-[#780000] transition-all duration-300 ease-linear text-white px-4 py-2 mt-2 rounded flex items-center gap-1"
      >
